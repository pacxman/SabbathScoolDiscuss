...
import com.bhprojects.bibleprojectkiny.FocusedChildLinearLayoutManager;
...
public class LessonSeven extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new FocusedChildLinearLayoutManager(getContext()));
        ...
        //panelHandler.initializeTextDialog();
    ...
    public static Fragment newInstance(String text, Parser parse, TopProgressBar pb) {
        LessonSeven f = new LessonSeven();
        Bundle b = new Bundle();
        f.setArguments(b);
        pbar = pb;
        parser = parse;
